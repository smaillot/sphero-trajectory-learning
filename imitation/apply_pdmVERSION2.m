...
% Get the direction of the PMD library
...
%    time_period=take_move(freq,1,50);
    ...
    prompt='Choose movement data';
    uiwait(msgbox('enter the name of your data file','Data_Collecting','modal'))
    name=inputdlg(prompt);
    name=name{1};
end
[tau,data]=get_data2(name);
